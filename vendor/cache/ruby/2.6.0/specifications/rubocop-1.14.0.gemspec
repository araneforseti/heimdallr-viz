...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rubocop/rubocop/issues", "changelog_uri" => "https://github.com/rubocop/rubocop/blob/master/CHANGELOG.md", "documentation_uri" => "https://docs.rubocop.org/rubocop/1.14/", "homepage_uri" => "https://rubocop.org/", "source_code_uri" => "https://github.com/rubocop/rubocop/" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<rubocop-ast>.freeze, [">= 1.5.0", "< 2.0"])
    ...
    s.add_dependency(%q<rubocop-ast>.freeze, [">= 1.5.0", "< 2.0"])
